...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link type="Local Area Network" mimeType="" format="" size="" name="Shapefile" description="" url="file://\\DGRLGM71\C$\Essential GIS\Data\Iowa-Statewide data\Counties"/>
  </links>
  <fees></fees>
  ...
  <extent>
    <spatial crs="EPSG:4326" miny="4470598.39718599990010262" dimensions="2" maxz="0" maxx="736849.21039300004485995" maxy="4822673.78653900045901537" minx="202073.80872299999464303" minz="0"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
